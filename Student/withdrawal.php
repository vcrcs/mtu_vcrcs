...
<div class="page-sidebar-wrapper">
                <div class="page-sidebar navbar-collapse collapse">
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                        ...
                        <li class="nav-item  ">
                            <a href="VideoCall_PeerJS-main/index.html" class="nav-link nav-toggle">
                                <i class="icon-diamond"></i>
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Request for Withdrawal
                    </h3>
				...
				if (isset($_POST['submit_form'])){		
                                      ...
                                      $withdraw_id = generateRandomString();
										...
										$run = mysqli_query($con,"select * from student where stud_id ='$session_id'")or die(mysqli_error());
										...
										$querys = "SELECT * FROM Withdrawal WHERE stud_id='$id' ";
							   ...
							   echo '<div class="alert alert-dismissable alert-danger" style="margin-top:-20px;">';
												echo '<strong>'.'<center>'."You have already requested withdrawal ! ".'</center>'.'<strong>';
												echo '</div>';
							   }
										
										else{
											mysqli_query($con,"insert into withdrawal( withdraw_id,stud_id, full_name,department,reason,document,date,year,status) values('$withdraw_id','$id','$fullname','$dept','$comment','"."$image_name"."','$date','$year','$status')")or die(mysqli_error());
...
PLEASE DON'T ENGAGE TO DO ANYTHING BEFORE YOUR WITHDRAW REQEUEST APROVE !! 
                                        ...
                                        <div class="form-actions">
                                            <div class="row" style="margin-left:700px">
                                                <div class="col-md-offset-3 col-md-9">
                                                    ...
                                                    <button type="reset" href="index.php" class="btn default">Cancel</button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
