                ...
                <div class="page-content">
                    ...
                    <div class="profile">
                        ...
                        <tr>
                            ...
                            <th class="head1">Instructor Id</th>
                            <th class="head0">Attached FIle</th>
                            <th class="head1">Submission Date</th>
                    ...
                    <tbody>
					<?php
						          $querys = mysqli_query($con,"SELECT * FROM Submit WHERE course_code='$id' AND stud_id='$session_id' ");
								  $array = array();
								  $X=0;
								  while($rows = mysqli_fetch_assoc($querys)){
								  $array[] = $rows; 
								 ...
								 ?>
                        <tr class="gradeX">
                            <td><?php echo $rows['assignment_id'];?></td>
							<td><?php echo $rows['inst_id'];?> </td>
                            <td><?php echo $rows['file'];?></td>
							<td><?php echo $rows['date'];?></td>
							<td class="center"><a  href="deletesubmitted.php?ID=<?php echo $rows['assignment_id'];?>" data-toggle="modal" style="font-size:16px;"><b>Delete</b></a> 
							</td>
                        </tr> <?php } ?>
