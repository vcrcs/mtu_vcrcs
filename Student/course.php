                            ...
                            <div class="portlet light portlet-fit bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green bold uppercase">Document</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="mt-element-card mt-element-overlay">
									  ...
									  ?>
										   ...
										   echo '<strong>'.'<center>'."There is No Document Course Material! ".'</center>'.'<strong>';
										   echo '</div>';
									   }
										}
										if($K==0){
