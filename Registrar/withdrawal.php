               ...
               <div class="page-content">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i>List of Withdrawal Request</div>
					...
					<?php
                        ...
                        <tr class="gradeX">
							...
							<td class="center"><a  href=" aprovewithdraw.php?ID=<?php echo $idnum;?> " data-toggle="modal" style="font-size:14px;">View Request</a></td>
                        </tr> <?php } ?>
