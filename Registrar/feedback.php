        ...
        <div class="page-container">
           ...
           <div class="page-content-wrapper">
               <div class="page-content">
                    ...
                    <h3 class="page-title"> List of Feedbacks </h3>
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
									...
									<?php 
									   $year=date('Y');
									?>
                                        <i class="fa fa-cogs"></i>List of All Feedbacks </div>
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
                                        ...
                                        <tbody>
											<?php
								  $querys = mysqli_query($con,"SELECT * FROM Feedback ");
								  $array = array();
								 ...
								 ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a  href="deletefeedback.php?ID=<?php echo $id;?>" > Delete </a>
                                                </td>
                                            </tr><?php } ?>
                                        </tbody>
                                    </table>
