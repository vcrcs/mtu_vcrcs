                        ...
                        <div class="row">
							...
							<?php
								        ...
								        $da=mysqli_fetch_array($ans);
									         $to_email =$da["e_mail"];
											 $sta="New";
									$ab = mysqli_query("SELECT * FROM Mail WHERE send_to='$to_email' AND status_to='$sta' OR status_to='Read'"); 
										  $X=0;
                        ...
                        <button class="btn btn-default btn-sm"><i class="fa fa-chevron-right"></i></button>
										...
										<?php 
									     ...
									     $row=mysqli_fetch_array($result);
									         $e_mail =$row["e_mail"];
											 $stata="New";
                                          $querys = mysqli_query($con,"SELECT * FROM Mail WHERE send_to='$e_mail' AND status_to='$stata' OR status_to='Read' ORDER by date"); 
								          $array = array();
										  $K=0;
										  $no_sent="You donot have an inbox yet";
										...
										?>
                                              <tbody>
                                                  <tr>
												    ...
												    <h4 style="margin-top:70px; margin-left:50px;">  <?php if($X==0){
														   echo $no_sent;
													   }
													   ?>
											  </tbody>
