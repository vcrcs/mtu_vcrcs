           ...
           <div class="page-content-wrapper">
               <div class="page-content">
                    ...
                    <h3 class="page-title"> Leave Request
                        <small>List of sfaff request for leave</small>
                    </h3>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>List of Accepted leave Request Report </div>
					...
					<div class="row">
                        <div class="col-md-12">
                            <div class="portlet box red">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-cogs"></i>List of Rejected Leave Request Report </div>
                                    <div class="tools" style="margin-left:-93px;">
                                        <a href="javascript:;" class="collapse"> </a>
                                    </div>
                                </div>
