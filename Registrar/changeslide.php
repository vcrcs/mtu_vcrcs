...
<?php include('sidebar.php');?>
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <h3 class="page-title">Upload Image to Change Slides
                    </h3>
				...
				if (isset($_POST['submit_form'])){		
										...
										$id= $rows['id'];
										mysqli_query($con,"Update Slide set status='$sta' where id='$id'")or die(mysqli_error());
										mysqli_query($con,"insert into Slide( slide_1,slide_2, slide_3,slide_4,user_id,status) values('"."$image_name1"."','"."$image_name2"."','"."$image_name3"."','"."$image_name4"."','$session_id','$status')")or die(mysql_error());
										move_uploaded_file($image1,"../Uploads/".$image_name1);
										move_uploaded_file($image2,"../Uploads/".$image_name2);
										move_uploaded_file($image3,"../Uploads/".$image_name3);
										move_uploaded_file($image4,"../Uploads/".$image_name4);
										echo '<div class="alert alert-dismissable alert-success" style="margin-top:-20px;">';
										echo '<strong>'.'<center>'."You have change Home Photo Slide Successfully! ".'</center>'.'<strong>';
										echo '</div>';
										}
		...
		?>
                                        ...
                                        <div class="form-body">
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">Slide 1
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="file" class="form-control" placeholder="" name="image1" id="image" required>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">Slide 2
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="file" class="form-control" placeholder="" name="image2" id="image" required>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
											<div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">Slide 3
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="file" class="form-control" placeholder="" name="image3" id="image" required>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
											<div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="form_control_1">Slide 4
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-9">
                                                    <input type="file" class="form-control" placeholder="" name="image4" id="image" required>
                                                    <div class="form-control-focus"> </div>
                                                </div>
                                            </div>
                                         </div>
                                        <div class="form-actions">
                                            <div class="row" style="margin-left:700px">
                                                <div class="col-md-offset-3 col-md-9">
                                                    <button type="submit" class="btn green" name="submit_form" id="submit_form" >Change Image</button>&nbsp;&nbsp;&nbsp;
