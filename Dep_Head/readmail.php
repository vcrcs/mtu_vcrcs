                            ...
                            <div class="col-md-10">
                                <div class="inbox-body">
                                    <div class="inbox-header">
                                        <h1 class="pull-left">Read More</h1>
                    ...
                    <div class="pull-right">
                      ...
                      <div class="btn-group">
                        ...
                        <button class="btn btn-default btn-sm"><i class="fa fa-chevron-right"></i></button>
										...
										<?php 
										$id=$_GET['ID'];
										 mysqli_query($con,"update mail set status_to='Read' where id='$id'" )or die(mysqli_error());
										 $query = "SELECT * FROM Account WHERE user_id='$session_id'";
								         $result = mysqli_query($con,$query)or die(mysqli_error());
								         $num_row = mysqli_num_rows($result);
									     $row=mysqli_fetch_array($result);
                                          $querys = mysqli_query($con,"SELECT * FROM Mail WHERE id='$id' "); 
								          $array = array();
										...
										?> <tbody>
                                                  <tr>
													   ...
													   <p style="text-align:right;">
													     Sender : <?php echo $r['f_name']." ".$r['l_name']; ?><br>
														 Sender e_mail :<?php echo $sender; ?><br></p>
													   <p>
													     Dear : <?php echo $row['f_name']." ".$row['l_name']; ?></p>
													   <hr>
													   <p><?php echo $string;?></p>
													   <hr>
													   <?php
													   $data=trim($rows['attachment']);
													  
													   if($data==""){
														   
													   }
													   else {
														echo ' <div class="mt-element-card mt-element-overlay" style="width:530px;">';
													    echo ' <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">';
                                                        echo ' <div class="mt-card-item">';
                                                        echo ' <div style="width:100px;" class="mt-card-avatar mt-overlay-1">';
                                                        echo ' <img style="width:100px;" src="../uploads/doc.jpg" />';
                                                        echo ' <div class="mt-overlay">';
                                                        echo ' <ul class="mt-info">';
                                                        echo ' <li>';
                                                        echo ' <a class="btn default btn-outline" href="../uploads/'.$data.'">';
                                                        ...
                                                        echo ' </div>';
                                                        echo ' </div>';
                                                        echo ' <div style="width:100px;" class="mt-card-content">';
                                                        echo ' <p style="font-size:12px;">'.$data.'</p>';
