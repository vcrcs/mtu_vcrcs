...
<?php  $get_id=$_GET['id']; ?>
<?php
$teacher_query=mysqli_query($con,"select * from teacher where teacher_id='$get_id'")or die(mysqli_error());
...
<body>
	...
	$image_size= getimagesize($_FILES['image']['tmp_name']);
			...
			mysqli_query($con,"update teacher set username='$username',password='$password',firstname='$firstname',lastname='$lastname',middlename='$middlename',
