                ...
                <div class="page-content">
                    ...
                    <div class="profile">
                        <div class="tabbable-line tabbable-full-width">
                            ...
                            <div class="portlet box green">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-globe"></i>Submitted Assignment List of <?php echo $id;?></div>
                        ...
                        <tr>
                            ...
                            <th class="head1">Submittion Date</th>
                    ...
                    <?php
                                  ...
                                  $querys = mysqli_query($con,"SELECT * FROM Submit WHERE course_code='$id' ");
                                  $array = array();
                                  $X=0;
                                  while($rows = mysqli_fetch_assoc($querys)){
                                  $array[] = $rows; 
                                  $idnum=$rows['assignment_id'];
                                 ?>
                        <tr class="gradeX">
                            <td><br><?php echo $rows['assignment_id'];?></td>
                            <td><br><?php echo $rows['stud_id'];?> </td>
                            <td><br><?php echo $rows['file'];?></td>
                            <td><br><?php echo $rows['date'];?></td>
                            <td class="center"><a  href="../uploads/<?php echo $rows['file'];?>" data-toggle="modal" style="font-size:16px;"><b>Download</b></a><br><br>
