...
?>
            <div class="page-content-wrapper">
                <div class="page-content">
                    ...
                    <tbody>
					<?php
						          $querys = mysqli_query($con,"SELECT * FROM Assignment WHERE inst_id='$session_id' AND code='$id' ");
								  $array = array();
								  $X=0;
								  while($rows = mysqli_fetch_assoc($querys)){
								  $array[] = $rows; 
                        ...
                        <tr class="gradeX">
							...
							<td class="center"><a  href="viewinstructor.php?ID=<?php echo $idnum;?>" data-toggle="modal" style="font-size:16px;"><b>Delete</b></a> 
							</td>
                        </tr> <?php } ?>
